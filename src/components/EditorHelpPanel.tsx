      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6 editor-help-scroll">
              ...
              <div className="mt-8 p-4 rounded-lg bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/20 mb-6">
